...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de idioma para validación personalizada
    |--------------------------------------------------------------------------
    |
    ...
    | permite especificar rápidamente un mensaje personalizado para una regla
    ...
    */
    ...
    | de posición del atributo con algo más amigable para el lector, como
